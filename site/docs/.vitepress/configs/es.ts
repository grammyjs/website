...
export const siteEs: LocaleConfig = {
  es: {
    ...
    themeConfig: {
      ...
      returnToTopLabel: "Volver arriba", // only displayed in the mobile view.
      langMenuLabel: "Cambiar de idioma", // Aria-label
      socialLinks: [
        {
          ...
          ariaLabel: "Enlace al grupo de Telegram de grammY",
        },
        {
