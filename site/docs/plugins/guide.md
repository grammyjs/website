...
- Middleware Plugins: The plugin's sole job is to return a [middleware function](../guide/middleware.html) that can be fed to a grammY bot.
- Transformer Plugins: The plugin's sole job is to return a [transformer function](../advanced/transformers.html) that can be fed to a grammY bot.
