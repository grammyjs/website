...
// Create a bot.
const bot = new Bot(""); // <-- pass your bot token here
...
The sink contains a queue ([API reference](https://deno.land/x/grammy_runner/mod.ts?s=DecayingDeque)) of individual updates that are currently being processed.
