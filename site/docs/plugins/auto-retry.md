...
> Consider using [the throttler plugin](./transformer-throttler.html) instead.

This plugin is an [API transformer function](../advanced/transformers.html), which means that it let's you intercept and modify outgoing HTTP requests on the fly.
