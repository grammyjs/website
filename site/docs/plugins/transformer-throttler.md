...
Consider using the [auto-retry plugin](./auto-retry.html) together with this plugin, if you are experiencing floodwait errors for certain API calls, such as `api.sendContact`.
:::
