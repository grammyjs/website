...
This feature come in handy when your bot has [custom keyboards](./keyboard.md#custom-keyboards) containing localized text.
...
The `hears` middleware makes sure that the message the bot is listening for, is written in the same locale of the user.
