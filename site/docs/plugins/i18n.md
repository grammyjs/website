...
When you are targeting an international audience with your bot, you will want to internationalize your bot by making it multilingual.
The i18n plugin helps in this process and lets you internationalize your bot.

The i18n plugin is based on the [Fluent](https://projectfluent.org/)—a localization system supported by Mozilla.
...
help = 
    Schick eine Textnachricht, die ich für dich fett machen soll.
    Du kannst auch mit dem Befehl /language die Spache ändern.
```
...
We already saw how to configure the i18n instance [with](#with-sessions) and [without sessions](#without-sessions).
...
Placeables are the way to inject data into a translation string.
...
Functions are like placeables. but unlike placables, functions get executed and replaced by the value it returns.
