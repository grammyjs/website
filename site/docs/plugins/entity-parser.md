...
You can modify specific rules by extending the default [`RendererHtml`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer_html.ts) or override all the rules by implementing the [`Renderer`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer.ts).
...
If you are unsure which interface is correct, refer to how the [Renderer](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer.ts) or [RendererHtml](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer_html.ts) is implemented.
...
You can override this behavior by specifying a `textSanitizer` when instantiating the [`EntitiesParser`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/mod.ts):

- If you do not specify `textSanitizer`, it will default to using [`sanitizerHtml`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/utils/sanitizer_html.ts) as the sanitizer.
...
- [Source](https://github.com/qz-project/telegram-entities-parser)
