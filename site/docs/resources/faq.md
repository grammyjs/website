...
1. Read [this article in the docs](../advanced/flood.html) to gain a basic understanding of the situation.
2. Use [the `transformer-throttler` plugin](../plugins/transformer-throttler.html).
3. Use [the `auto-retry` plugin](../plugins/auto-retry.html).
