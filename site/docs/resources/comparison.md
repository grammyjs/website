...
As a result, even though version 4.0 tried to _improve_ correctness and tooling
...
The `node-telegram-bot-api` package is the second big project that impacted the
