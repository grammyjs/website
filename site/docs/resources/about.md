...
You can find a list of all contributors [in the README of our repository](https://github.com/grammyjs/grammY#contributors-).
...
- File [an issue](https://github.com/grammyjs/grammY/issues) about a bug you discovered, a feature you'd like to see, or anything else.
- Help out with [the docs](https://github.com/grammyjs/website).
- Assist people in the community chats for [English](https://t.me/grammyjs) or [Russian](https://t.me/grammyjs_ru).
- Or just come tell us what you think!
  Already leaving a few words about your favorite feature help us determine the direction of the project.
