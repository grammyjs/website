...
1. 阅读 [这篇文章](/zh/advanced/flood.html) 以获得对情况的基本了解。
2. 使用 [`transformer-throttler` 插件](/zh/plugins/transformer-throttler.html)。
3. 使用 [`auto-retry` 插件](/zh/plugins/auto-retry.html)。
