...
本教程将指导你如何通过 [webhooks](/zh/guide/deployment-types.html#webhooks) 或者 [长轮询](/zh/guide/deployment-types.html#长轮询) 将 Telegram bot 部署到 [Heroku](https://heroku.com/)。
...
你可以在 [这里](/zh/guide/deployment-types.html) 了解更多关于两者之间的优缺点，再决定使用哪一个。
...
::: tip ⚡ 优化（可选）
每次你的服务器启动时，grammY 会向 Telegram 请求 [bot 的信息](https://core.telegram.org/bots/api#getme)，以便在 `ctx.me` 下的 [上下文对象](/zh/guide/context.html) 提供 bot 的信息。
...
我们已经准备好去部署它了。
看起来是不是非常简单？:smiley:
如果你觉得这太简单了，可以查看我们的 [部署清单](/zh/advanced/deployment.html#长轮询)！:rocket:
