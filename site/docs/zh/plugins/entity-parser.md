...
你可以通过扩展默认的 [`RendererHtml`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer_html.ts) 来修改特定规则，或者通过实现 [`Renderer`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer.ts) 来覆盖所有规则。
...
如果你不确定哪个接口是正确的，请参考 [Renderer](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer.ts) 或 [RendererHtml](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer_html.ts) 的实现方式。
...
你可以在实例化 [`EntitiesParser`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/mod.ts) 时指定 `textSanitizer` 来覆盖此行为：

- 如果你未指定 `textSanitizer`，它将默认使用 [`sanitizerHtml`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/utils/sanitizer_html.ts) 作为清理程序。
...
- [源码](https://github.com/qz-project/telegram-entities-parser)
