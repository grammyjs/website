...
© 2021-{{ new Date().getFullYear() }} &middot; grammY supports the Telegram Bot API 6.6 which was [released](https://core.telegram.org/bots/api#march-9-2023) on March 9, 2023.
