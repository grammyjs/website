...
1. Відкрийте посилання `https://api.telegram.org/bot<токен-бота>/getMe` в вашому улюбленному браузері. Рекомендується [Firefox](https://www.firefox.com/en-US/), бо він чудово працює з форматом `json`.
