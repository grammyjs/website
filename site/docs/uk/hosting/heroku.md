...
Зверніть увагу, що деякі браузери вимагають ручного [кодування](https://uk.wikipedia.org/wiki/Відсоткове_кодування#Відсоткове_кодування_зарезервованих_символів) вашого `webhook_url` перед передачею його.
