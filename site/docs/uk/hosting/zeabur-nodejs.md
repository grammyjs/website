...
>
> Ви можете ознайомитися з [цим посібником](https://zeabur.com/docs/en-US/deploy/config/environment-variables) щодо налаштування змінних середовища в Zeabur.
...
2. Перейдіть на [інформаційну панель Zeabur](https://zeabur.com/).
