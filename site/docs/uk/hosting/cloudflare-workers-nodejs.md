...
2. Робоче середовище [NodeJS](https://nodejs.org/) зі встановленим `npm`.
...
Далі вам буде запропоновано вибрати тип вашого worker'а, тут ми обираємо worker'а "Hello World":
...
::: tip
Ви можете змінити назву змінних оточення на будь-яку іншу, але памʼятайте, що в наступних кроках ви робите те ж саме.
:::
...
Якщо ви хочете ігнорувати застарілі оновлення (наприклад, ігнорувати всі оновлення під час розробки перед розгортанням у виробничому середовищі), ви можете додати параметр `offset` до методу `getUpdates` ось так:
...
::: tip
Не забудьте [встановити вебхук назаж](#встановлення-вашого-вебхуку) під час розгортання у продакшні.
:::
