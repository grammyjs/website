...
У цьому посібнику ми користуватимемося послугами [Hostinger](https://www.hostinger.com/ua).
...
Щоб позбутися цих рутинних дій і покращити досвід роботи з сервером, ви можете налаштувати SSH, створивши на своєму компʼютері файл `~/.ssh/config` (<https://linuxhandbook.com/ssh-config-file/>), який зберігає всі дані, необхідні для підключення до сервера, під певними довільними ідентифікаторами.
...
Перейдіть на [сторінку пошуку доменного імені](https://www.hostinger.com/ua/kupyty-domen).
У полі для введення тексту введіть доменне імʼя у вигляді `<імʼя>.<зона>`.
...
> Якщо у вас виникнуть проблеми, скористайтеся іншим способом, описаним в [базі знань](https://www.hostinger.com/support/1583227-how-to-point-a-domain-to-your-vps-at-hostinger/).
...
Зауважте, що вам потрібно додати три [секретні змінні середовища](https://docs.github.com/en/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets):
...
Зауважте, що вам потрібно додати три [змінні середовища](https://docs.gitlab.com/ci/variables/):
