...
Ми обрали [Hostinger](https://hostinger.com.ua) в якості нашого провайдера.
...
3. Ваша команда запуску повинна виглядати наступним чином:
   ...
   ```sh
   <повний-шлях-до-середовища-виконання> <опції> <повний-шлях-до-вхідного-файлу>
...
Вас буде автоматично перенаправлено на сторінку оформлення замовлення, де ви також зареєструєтесь у Hostinger, якщо досі не зареєстровані.
Оплатіть домен.
...
Так ви позбудетеся обмежень і зможете використовувати конвеєри будь-якої складності та потужності (майже).
:::
