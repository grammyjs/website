...
Однак це має недолік у тому, що ваш бот не має доступу до постійного сховища, як-от локальна файлова система.
...
Тому ми рекомендуємо використовувати інший тип хостингу для більш складних ботів: наприклад, [VPS](./vps.md).
