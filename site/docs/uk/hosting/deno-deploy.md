...
Це схоже на інші багатофункціональні серверні платформи, але присвячено для застосунків на Deno.

Результат цього посібника [можна побачити в нашому репозиторії прикладів ботів](https://github.com/grammyjs/examples/tree/main/deno-deploy).
...
замінивши `<токен>` на токен вашого бота, а `<адреса>` - на повну URL-адресу вашої програми разом з шляхом до обробника вебхуків.
