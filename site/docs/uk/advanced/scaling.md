...
Паралелізм - це складно, тому перегляньте [підрозділ нижче](#паралелізм-складнии), щоб дізнатися, про що слід пам'ятати при використанні цього плагіну.
...
// Додаємо звичайний middleware, тепер з підтримкою безпечних сесій.
