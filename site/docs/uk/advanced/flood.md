...
Але якщо погано обмежувати запити, то як можна робити трансляцію?
...
Вони роблять трансляцію повільнішою.
...
В майбутньому ми хочемо створити плагін для трансляції.
