...
Однак, якщо це не про вас, [прокрутіть униз](#порівняння-з-фреймворками-з-інших-мов-програмування), щоб перейти до порівняння про те, які мови програмування підходять для розробки ботів найкраще.
...
Цілком зрозуміло, що багато існуючих користувачів Telegraf 3 не бажали переходити на нову версію.
Новим користувачам також стало важче починати користуватися.
...
Це дало змогу проєкту мати чистий, узгоджений, компілювальний код, який надає користувачам відмінні типи (=підтримка редакторів коду).
...
5. **Підтримка `async`/`await`.**
   ...
   grammY вже тут.
   (Інші менш відомі фреймворки на Python можуть переходити швидше.
