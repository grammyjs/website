...
В основі обох лежить [система проміжних обробників](../guide/middleware).
...
Позбувшись від такої спадщини, grammY також зміг значно вдосконалити систему проміжних обробників, що дозволило реалізувати такі цікаві можливості, як [фільтри запитів](../guide/filter-queries), [межі помилок](../guide/errors#межі-помилок), [перетворювачі API](../advanced/transformers) та багато інших можливостей.
