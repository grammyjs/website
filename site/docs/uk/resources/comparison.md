...
- grammY має [документацію](../).
  Telegraf її не має: замість неї слугує згенерований довідник API, який не містить пояснень, а ті кілька посібників, що існують, є неповними і їх важко знайти.
...
- Багато інших речей, як-от краща продуктивність, велика екосистема плагінів, документація, перекладена для мільярдів людей, краща інтеграція з базами даних і вебфреймворками, краща сумісність під час виконання, розширення [VS Code](https://marketplace.visualstudio.com/items?itemName=grammyjs.grammyjs) тощо, які ви відкриєте для себе в процесі роботи.
...
Якщо ви твердо налаштовані використовувати щось іншу мову програмування, то можете припинити читання тут.
...
Це порівняння буде обмежено Python, Go та Rust.
...
Це набагато менш актуально, коли ви пишете бота, тому що більша частина часу витрачається на очікування мережі, але з часом це почне мати значення, як швидко ваш бот може розбирати JSON.
...
Якщо ви хочете використовувати Rust, то робіть це, але не забувайте наголошувати на тому, що ви любите Rust і зазначати, що це правильний інструмент для роботи.
