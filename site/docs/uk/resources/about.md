...
grammY - це програмне забезпечення, завдяки якому ви можете запрограмувати свій власний [чат бот](https://core.telegram.org/bots) для [Telegram Messenger](https://telegram.org).
...
Ви можете знайти список усіх учасників в [README](https://github.com/grammyjs/grammY#contributors-) нашого репозиторію.
...
Ми вітаємо участь усіх бажаючих.
