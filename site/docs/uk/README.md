...
© 2021-2026 &middot; grammY підтримує Telegram Bot API 10.1, який був [випущений](https://core.telegram.org/bots/api#june-11-2026) 11-го червня 2026 року.
Остання зміна: Розширене форматування.
