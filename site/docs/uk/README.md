...
© 2021-2025 &middot; grammY підтримує Telegram Bot API 8.1, який був [випущений](https://core.telegram.org/bots/api#december-4-2024) 4-го грудня 2024 року.
Остання зміна: партнерські програми.
