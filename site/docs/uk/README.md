...
© 2021-2024 &middot; grammY підтримує Telegram Bot API 8.0, який був [випущений](https://core.telegram.org/bots/api#november-17-2024) 17-го листопада 2024 року.
Остання зміна: десять покращень мінізастосунків.
