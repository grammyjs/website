...
© 2021-2024 &middot; grammY підтримує Telegram Bot API 7.2, який був [випущений](https://core.telegram.org/bots/api#march-31-2024) 31-го березня 2024 року.
Остання зміна: інтеграція з бізнес-акаунтами.
