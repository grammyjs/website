...
Якщо ви надішлете [вбудовану клавіатуру](./keyboard#побудова-вбудованої-клавіатури) з кнопкою `switchInline`, користувач буде повернутий до чату, де він спочатку натиснув кнопку результатів inline-запиту.
