...
Перегляньте розділ [_Випадки, коли краще не використовувати цей пакет_](#випадки-коли-краще-не-використовувати-цей-пакет), щоб визначити, чи є у вас подібна проблема, яку потрібно вирішити.
