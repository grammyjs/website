...
Памʼятайте, що ви можете прослуховувати текстові повідомлення за допомогою `bot.on("message:text")` або `bot.hears()`.
...
За замовчуванням клавіатура має розмір звичайної клавіатури програми.
