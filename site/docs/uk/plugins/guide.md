...
- Плагіни проміжного обробника: задачею плагіна є повернути [функцію проміжного обробника](../guide/middleware), яку можна використовувати в боті grammY.
- Плагіни-перетворювачі: задачею плагіна є повернути [функцію-перетворювач](../advanced/transformers), яку можна використовувати в боті grammY.
...
Нарешті, ви повинні знати, що хоча grammY підтримує як Node.js, так і [Deno](https://deno.com/runtime), він є проєктом, спрямованим на Deno, і ми також підтримуємо написання плагінів для Deno (згодом й у стилі!).
