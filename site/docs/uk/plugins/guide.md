...
Ви можете опублікувати свій плагін в одному з таких варіантів:

- Опублікувати як **офіційний** плагін.
- Опублікувати як **плагін від сторонніх розробників**.

Якщо ви вирішите опублікувати свій плагін як сторонній, ми все ще можемо запропонувати вам видне місце на цьому веб-сайті. Однак, ми більш перевагу віддаємо, якщо ви публікуєте свій плагін в [організації grammyjs](https://github.com/grammyjs) на GitHub, зробивши його офіційним плагіном.
...
Перед тим як перейти до деяких практичних прикладів, є кілька правил, на які потрібно звернути увагу, якщо ви хочете, щоб ваші плагіни були включені до списку на цьому веб-сайті.

1. Необхідно мати файл README на GitHub (та npm) з **короткими і чіткими** інструкціями щодо використання плагіна.
2. Поясніть призначення вашого плагіна та як його використовувати, додавши сторінку до [документації](https://github.com/grammyjs/website). Якщо ви не впевнені, як це зробити, ми можемо створити сторінку за вас.
3. Оберіть ліцензію з дозволом на використання, наприклад MIT або ISC.

Нарешті, ви повинні знати, що хоча grammY підтримує як Node.js, так і [Deno](https://deno.land/), він є проектом, спрямованим на Deno, і ми також підтримуємо написання плагінів для Deno (і, відповідно, в стилі!).
...
Тем не менш, ми дуже рекомендуємо спробувати Deno.
Ви не захочете повертатися назад.

## Розробка тестового middleware плагіну

Припустимо, ми хотіли б розробити плагін, який реагує тільки на певних користувачів!
...
Ось і все!
Ви створили свій власний плагін, хіба не так?
Але не так швидко.
Нам ще потрібно упакувати його, але перед цим давайте поглянемо на trnsformer плагіни.

## Розробка тестового transformet плагіну

Уявіть, що ви пишете плагін, який автоматично надсилає відповідну [дію чату](https://core.telegram.org/bots/api#sendchataction) кожного разу, коли бот надсилає документ.
...
Тепер кожного разу, коли ми відправляємо документ, дія чату `upload_document` буде відправлена нашому клієнту.
...
Ймовірно, вам не потрібно встановлювати статус, якщо файл дуже малий, тому тут є деякі оптимізації, які можна зробити.
...
У `deno2node` є функція, яка дозволяє надавати йому файлів, специфічних для рантайму.
...
> _**Примітка**_: Ви також можете використовувати інші інструменти, такі як [deno dnt](https://github.com/denoland/dnt), для компіляції вашого коду Deno, або використовувати іншу структуру папок.
...
**`README.md`**: Інструкції по використанню плагіну.
**Переконайтеся, що зміните його згідно з вашим проектом**.

**`index.ts`**: Це файл, що містить бізнес-логіку вашого плагіна, тобто ваш основний код плагіна.

## Шаблон плагіну

Якщо ви хочете розробити плагін для grammY і не знаєте, з чого почати, ми дуже рекомендуємо використовувати код зразка, що знаходиться у [нашому репозиторії](https://github.com/grammyjs/plugin-template).
Ви можете клонувати код до себе та почати програмування, користуючись тим, що було розглянуто у цій статті.
У цьому репозиторії також є додаткові корисні файли, такі як `.editorconfig`, `LICENSE`, `.gitignore` і т.д., але ви можете видалити їх за потреби.

## Мені не подобається Deno

Добре, ви щось втрачаєте!
Але ви також можете писати свої плагіни тільки для Node.js.
Ви все ще можете опублікувати плагін і додати його до списку сторонніх плагінів на цьому веб-сайті.
У такому випадку ви можете використовувати будь-яку структуру папок, яку бажаєте (якщо вона організована, як будь-який інший npm-проект).
Просто встановіть grammY через npm з `npm install grammy` і починайте кодувати.

## Як подати заявку?

Якщо у вас є готовий плагін, ви можете просто створити pull request на GitHub (відповідно до [правил внеску](#rules-of-contribution)), або повідомити нас у [спільноті чату](https://t.me/grammyjs) для подальшої допомоги.
