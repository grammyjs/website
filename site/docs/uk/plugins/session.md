...
> [Перейдіть вниз](#як-використовувати-сесії), якщо ви вже знаєте, як працюють сесії.
...
Ви можете прочитати більше про ключі сесії [тут](#ключі-сесії).
...
> [Пропустіть цей розділ](#як-використовувати-сесії), якщо ви вже знаєте, що хочете використовувати сесії.
...
Також можна використовувати різні [ключі сесії](#ключі-сесії) для кожного фрагмента.
...
Плагін сесії здатен покращити будь-який адаптер сховища, додавши йому більше можливостей: [тайм-аути](#тайм-аути) та [міграції](#міграції).
