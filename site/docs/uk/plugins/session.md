...
Переконайтеся, що ви розумієте наслідки такої конфігурації, прочитавши [цю статтю](../guide/deployment-types.md) й особливо [цю](./runner.md#sequential-processing-where-necessary).
:::
