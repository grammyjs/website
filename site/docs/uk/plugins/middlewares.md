...
Я постійно переписував ті самі middlewares знову і знову для всіх своїх ботів, тому я вирішив витягнути їх усі в окремий пакет.
...
Всі фабрики middlewares доступу є фабриками, навіть якщо не всі з них повинні бути такими.
