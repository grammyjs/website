...
Ви можете переглянути цей [розділ](../advanced/scaling#паралелізм-складний), щоб дізнатися, як ним користуватися.
...
Це дивовижно, тому що [паралелізм складний](../advanced/scaling#паралелізм-складний), а це означає, що якщо є лише один потік, знімається багато головного болю.
