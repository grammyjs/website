...
Ви можете переглянути цей [розділ](../advanced/scaling.md#паралелізм-складний), щоб дізнатися, як ним користуватися.
...
Це дивовижно, тому що [паралелізм складний](../advanced/scaling.md#паралелізм-складний), а це означає, що якщо є лише один потік, знімається багато головного болю.
