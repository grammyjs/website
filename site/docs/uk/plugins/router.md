...
Наприклад, поєднання цих двох концепцій дозволяє повторно створювати форми в інтерфейсі чату.
...
> Ми збережемо цю сторінку як довідник для тих, хто використовував маршрутизатор для форм.

Припустимо, ви хочете створити бота, який повідомляє користувачам, скільки днів залишилося до їхнього дня народження.
Щоб обчислити кількість днів, бот повинен знати місяць і день місяця дня народження: наприклад, місяць - червень, день місяця - 15-й.
...
Тільки якщо обидва значення відомі, бот може сказати користувачеві, скільки днів залишилося.
...
bot.command("birthday", async (ctx) => {
  ...
  if (day !== undefined && month !== undefined) {
    ...
    await ctx.reply(
"Будь ласка, надішліть мені день місяця \
вашого дня народження у вигляді числа!",
    );
  }
});
