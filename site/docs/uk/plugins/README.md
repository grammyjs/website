...
grammY може використовувати переваги двох типів плагінів: _middleware_ та _перетворювачів_.
Простіше кажучи, плагіни в grammY повертають або middleware функцію, або функцію-перетворювач.
...
[Перетворювач](../advanced/transformers.md) - це повна протилежність middleware!
