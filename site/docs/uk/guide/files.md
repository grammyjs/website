...
> Якщо ви хочете знати, як ви можете працювати з файлами в grammY, прокрутіть униз до розділу про завантаження файлів [на сервер](#отримання-файлів) та [з серверу](#надсилання-файлів).
...
> Якщо можливо, вам слід віддати перевагу [надсиланню файлу через URL-адресу](#через-file_id-або-url-адресу), а не використовувати `InputFile` для потокової передачі вмісту файлу через ваш сервер.
