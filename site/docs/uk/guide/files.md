...
Ви можете повторно використовувати той самий `file_id` скільки завгодно, наприклад, ви можете надіслати той самий файл до п’яти різних чатів, використовуючи той самий `file_id`.
...
> Перегляньте [скорочення `:media` та `:file`](./filter-queries.md#скорочення) для запитів фільтрування, якщо ви хочете отримувати будь-які файли.
