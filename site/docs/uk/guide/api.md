...
> Примітка: якщо ви працюєте з великими файлами через [тривале опитування](./deployment-types.md), вам варто використовувати [конкурентність для grammY](../plugins/runner.md).
