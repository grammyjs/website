...
Розгляньте можливість використання [ESLint](https://eslint.org/) і налаштуйте його на використання [no-floating-promises](https://github.com/typescript-eslint/typescript-eslint/blob/main/packages/eslint-plugin/docs/rules/no-floating-promises).
