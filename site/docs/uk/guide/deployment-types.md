...
Наприклад, плагін сеансу неминуче вийде з ладу через конфлікт [запису після читання](https://en.wikipedia.org/wiki/Hazard_(computer_architecture)#Write_after_read_(WAR)).
