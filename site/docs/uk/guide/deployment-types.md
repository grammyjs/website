...
Ваш бот може отримати оновлення через тривале опитування або сервери Telegram можуть передати їх вашому боту через вебхуки.
...
Коли grammY надсилає запит до Telegram і тим часом вашому боту надсилаються нові повідомлення, Telegram повертає їх у вигляді масиву до 100 об’єктів.
