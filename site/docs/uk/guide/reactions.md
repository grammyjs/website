...
Наприклад, за допомогою вбудованого тривалого опитування ви можете увімкнути їх таким чином:
...
Ви також можете імпортувати `API_CONSTANTS` з grammY, в подальшому використавши змінну як
