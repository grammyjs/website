...
Той самий обʼєкт контексту для одного оновлення буде спільно використовуватися всіма встановленими на боті middlaware ([документація](./middleware.md)).
...
Однак ми рекомендуємо вам налаштовувати обʼєкт контексту [через middleware](#через-middleware-рекомендовано), оскільки він гнучкіший і краще працює, якщо ви хочете встановити плагіни.
...
Flavor це спосіб повідомити TypeScript про нові властивості вашого обʼєкта контексту.
...
Якщо у вас є різні [додаючі flavor](#додаючии-flavor), ви можете просто встановити їх наступним чином:
...
Кілька [перетворюючих flavor](#перетворюючии-flavor) також можна комбінувати:
