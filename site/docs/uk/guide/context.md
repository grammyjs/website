...
- [виконати дії у відповідь на повідомлення](#доступні-дії).
...
Якщо у вас є різні [додавальні розширювачі](#додавальний-розширювач), ви можете просто встановити їх наступним чином:
...
Кілька [перетворювальних розширювачів](#перетворювальний-розширювач) також можна комбінувати:
