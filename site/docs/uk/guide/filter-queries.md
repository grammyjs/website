...
Кожна частина буде зіставлена з функцією, яка виконує одну перевірку істинності для властивості обʼєкта або дві перевірки, якщо частина запиту пропущена і потрібно перевірити два значення.
...
Як згадувалося вище, запити фільтрування автоматично звужують певні властивості обʼєкта контексту.
