...
The Telegram backend allows your bot to [send files](./files.html) up to 2000 MB.
...
> Note: if you are working with large files over [long polling](./deployment-types.html), you should use [grammY runner](../plugins/runner.html).
...
As mentioned [earlier](./basics.html#sending-messages), you can specify other options in the third argument of type `Other`:
