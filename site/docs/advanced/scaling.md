...
Making your bot able to handle high load depends on whether you run your bot [via long polling or via webhooks](/guide/deployment-types.html).
...
Instead, **the [grammY runner](/plugins/runner.html) package can be used** to run your bot.
...
If you want to dig deeper into the package, check out [this page](/plugins/runner.html).
...
Naturally, in order for this to work well under high load, you should make yourself familiar with [how to use webhooks](/guide/deployment-types.html#how-to-use-1).
