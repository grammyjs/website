...
[Remember](/guide/deployment-types.html#ending-webhook-requests-in-time) also that Telegram will deliver updates from the same chat in sequence, but updates from different chats concurrently.
