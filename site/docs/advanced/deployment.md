...
3. Use the [`transformer-throttler` plugin](../plugins/transformer-throttler) to avoid hitting rate limits.
4. **Optional.** Consider using the [`auto-retry` plugin](../plugins/auto-retry) to automatically handle flood wait errors.
