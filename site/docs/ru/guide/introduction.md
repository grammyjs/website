...
> Если вы уже знаете, что хотите использовать, перейдите к разделу [необходимые условия для Node.js](#необходимые-условия-для-nodejs) или [необходимые условия для Deno](#необходимые-условия-для-deno).
...
Готовы?
[Приступайте к работе](./getting-started#приступайте-к-работе-с-deno)! :robot:
...
Отлично!
[Приступайте к работе](./getting-started#приступайте-к-работе-на-node-js)! :robot:
