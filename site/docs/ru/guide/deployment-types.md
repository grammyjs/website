...
Наконец, обязательно прочитайте [замечательное руководство Марвина по всем вещам, связанным с вебхуками](https://core.telegram.org/bots/webhooks), написанный командой Telegram, если вы рассматриваете [запуск бота на вебхуках на VPS](../hosting/vps#запуск-бота-на-вебхуках).
