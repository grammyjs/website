...
Убедитесь, что вы понимаете последствия такой конфигурации, прочитав статью [здесь](../guide/deployment-types) и особенно [здесь](./runner#последовательная-обработка-при-необходимости).
:::
