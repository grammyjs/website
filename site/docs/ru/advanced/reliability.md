...
2. Затем нужно создать [source](/ref/runner/updatesource), который снова будет тянуть из очереди сообщений.
...
Таким образом, цена полного параллелизма заключается в том, что ни _по крайней мере один раз_, ни _наиболее один раз_ обработка не может быть гарантирована.
