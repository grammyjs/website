...
В данный момент grammY не поддерживает редактирование бизнес сообщений
...
Так же хотя в Telegram API есть методы для редактирования сообщений, они не реализованны в grammY.
