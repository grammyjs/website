...
В grammY есть [расширители контекста](../guide/context#context-flavors), которые можно использовать для настройки типа контекста.
...
Если вы не знаете, как это работает, вернитесь к [разделу о контекстных расширителях](../guide/context#context-flavors) в руководстве.
