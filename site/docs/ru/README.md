...
© 2021-2025 &middot; grammY поддерживает Telegram Bot API 9.1, который был [выпущен](https://core.telegram.org/bots/api#july-3-2025) 3-го Июля 2025 года
(Последнее изменение: Списки задач)
