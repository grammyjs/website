...
hero:
  ...
  taglines:
    ...
    - может отжарить всё, кроме блюд.
    - как два пальца об асфальт.
    - обработал миллиарды и миллиарды.
    - питаемый одержимостью.
  image:
    src: /images/Y.svg
    alt: логотип grammY
  actions:
...
© 2021-2024 &middot; grammY поддерживает Telegram Bot API 7.10, который был [выпущен](https://core.telegram.org/bots/api#september-6-2024) 6-го Сентября 2024 года
(Последнее изменение: Покупка платных медиа и раздача «Звёзд»)
