...
После этого откройте файл `tsconfig.json` и измените его, чтобы использовать эту
конфигурацию:
...
Нет... наш _Шикарный бот_ еще не готов к запуску. Сначала завершите эти этапы!
