...
В этом руководстве мы будем использовать услуги [Hostinger](https://www.hostinger.com/1).
...
Для этого в [Панели управления Hostinger](https://hpanel.hostinger.com/1) нажмите кнопку "Manage" рядом с вашим доменом.
