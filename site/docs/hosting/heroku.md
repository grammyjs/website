...
This tutorial will guide you how to deploy a Telegram bot to [Heroku](https://heroku.com/) by using either [webhooks](../guide/deployment-types.html#webhooks) or [long polling](../guide/deployment-types.html#long-polling).
...
You can learn more about the both advantages and then decide which ones is suitable in [these awesome tips](../guide/deployment-types.html)!
...
::: tip ⚡ Optimization (optional)
Every time your server starts up, grammY will request [information about the bot](https://core.telegram.org/bots/api#getme) from Telegram in order to provide it on the [context object](../guide/context.html) under `ctx.me`.
...
If you think it is too easy, check out our [Deployment Checklist](../advanced/deployment.html#long-polling)! :rocket:
