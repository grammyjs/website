...
3. Revise las opciones de configuración de `run` ([referencia de la API](/ref/runner/run.md)) y asegúrese de que se ajustan a sus necesidades, o incluso considere la posibilidad de componer su propio corredor a partir de [sources](/ref/runner/UpdateSource.md) y [sinks](/ref/runner/UpdateSink.md).
