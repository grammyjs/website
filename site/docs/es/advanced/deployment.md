...
4. Considere implementar un [apagado gradual](./reliability.md#graceful-shutdown) para parar tu bot cuando tu quieres terminar con él (e.j. cambiar a una nueva versión).
