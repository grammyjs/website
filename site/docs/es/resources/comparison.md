...
La seguridad tipográfica a su vez permite características más avanzadas que cambian fundamentalmente la forma en que pensamos sobre el desarrollo de bots, como los [transformadores de la API](../advanced/transformers.html).
...
Ambos tienen un [sistema de middleware](../guide/middleware.html) en su núcleo.
...
Al ser liberado del legado, grammY también podría hacer contribuciones sustanciales al sistema de middleware subyacente, permitiendo emocionantes casos de uso como [consultas de filtro](../guide/filter-queries.html), [límites de error](../guide/errors.html#error-boundaries), [transformadores de API](../advanced/transformers.html), y muchos más.
