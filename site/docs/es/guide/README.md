...
2. 2. [Referencia de bajo nivel de la API de grammY](https://doc.deno.land/https://deno.land/x/grammy/mod.ts)
3. 3. [Referencia de la API HTTP en bruto de Telegram](https://core.telegram.org/bots/api)
