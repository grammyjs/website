...
2. [Referencia de bajo nivel de la API de grammY](/ref/core/)
...
La sección _Aprender_ es siempre un buen comienzo, ya que explica todos los conceptos básicos.
También revisa nuestra gran colección de _Complementos_, y echa un vistazo a los _Ejemplos_.

**La segunda parte** es la [referencia de la API de grammY](/ref/), enlazada en la parte superior de la página.
...
Lo mismo ocurre con todos los plugins del ecosistema grammY.
Además de aparecer en el [resumen de referencias API](/ref/), los plugins tienen su referencia API enlazada en el resumen del plugin en la parte inferior de la página de cada plugin.
