...
> Lee más sobre los identificadores de archivo [aquí](../guide/files.md#como-funcionan-los-archivos-para-los-bots-de-telegram).
...
[Recuerda](../guide/basics.md#envio-de-mensajes) que siempre puedes especificar más opciones cuando llames a métodos de la API utilizando el objeto options de tipo `Other`.
...
Por ejemplo, puedes [introducir una conversación corta](./conversations.md#instalar-y-entrar-en-una-conversacion) con el plugin de conversaciones.
