...
> Si ya sabes estas cosas, desplázate a la derecha hasta [Cómo empezar](#cómo-empezar).
...
En otras palabras, la internacionalización es lo que permite la localización (ver [arriba](#¿qué-es-la-localización)).
...
> Hay [múltiples maneras](#añadir-traducciones) de añadir más idiomas a tu bot.
