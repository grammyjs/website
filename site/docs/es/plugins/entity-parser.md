...
[`RendererHtml`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer_html.ts)
por defecto o anular todas las reglas implementando el
[`Renderer`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/renderers/renderer.ts).
...
instancia de
[`EntitiesParser`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/mod.ts):

- Si no especifica `textSanitizer`, se utilizará de manera predeterminada
  [`sanitizerHtml`](https://github.com/qz-project/telegram-entities-parser/blob/main/src/utils/sanitizer_html.ts)
  como sanitizador.
...
- [Referencia](https://github.com/qz-project/telegram-entities-parser)
