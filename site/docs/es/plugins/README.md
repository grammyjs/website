...
Como ejemplo, el plugin [grammY runner](./runner.html) (`runner`) necesita ser instalado vía `npm install @grammyjs/runner`.
...
[Middleware](/guide/middleware.html) es una función que maneja los datos entrantes en varias formas.
...
Una [función transformadora](/advanced/transformers.html) es lo contrario del middleware.
...
Si quieres desarrollar un plugin y compartirlo con otros usuarios (incluso publicarlo en la web oficial de grammY), hay una [guía útil](./guide.html) que puedes consultar.
