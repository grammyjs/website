...
- Plugins de Middleware: El único trabajo del plugin es devolver una [función middleware](../guide/middleware.html) que puede ser alimentada a un bot de grammY.
- Plugins transformadores: El único trabajo del plugin es devolver una [función transformadora](../advanced/transformers.html) que puede ser alimentada a un bot de grammY.
