...
Kamu bisa meng-import function `webhookCallback` ([Referensi API](https://deno.land/x/grammy/mod.ts?s=webhookCallback)) dari grammY untuk mengonversi bot-mu menjadi middleware untuk framework yang diinginkan.
